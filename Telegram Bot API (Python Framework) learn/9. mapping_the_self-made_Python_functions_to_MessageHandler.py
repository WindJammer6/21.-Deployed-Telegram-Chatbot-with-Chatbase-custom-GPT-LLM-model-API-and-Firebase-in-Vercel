...
# (Youtube video by PW Skills Tech, titled 'How To Create Telegram Bot Using Python | Python Project 
# Complete Tutorial')
...
def start_python_function(update, context):
    update.message.reply_text("Hello, welcome to my navigation of Simplilearn's Youtube Channel telegram bot! (From WindJammer6)")
...
def help_python_function(update, context):
    ...
    /start -> Replies with the message: "Hello, welcome to my navigation of Simplilearn's Youtube Channel telegram bot! (From WindJammer6)"
...
# The 'update.message.text' code is used to access the text content of an incoming message in a Telegram 
# Bot.

# Here is a breakdown of the 'update.message.text' code:
...
#             common ones are: 
#             -> 'message.reply_text()': send a text message as a reply to the message sender in the Telegram 
#                                        Bot
#             -> 'message.text'        : to access the text of the message
#             -> 'message.sender'      : to get information about the sender
#             -> etc.
